...
class DessertTimer(lifecycle: Lifecycle): LifecycleObserver {
    ...
    init {
        lifecycle.addObserver(this) // Connect lifecycle object passed from owner to this class
    }

    @OnLifecycleEvent(Lifecycle.Event.ON_START) // Function called on ON_START event
    fun startTimer() {
