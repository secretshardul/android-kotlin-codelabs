...
class GameWonFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        args = GameWonFragmentArgs.fromBundle(arguments!!) // Get args from bundle passed by GameFragment
        Toast.makeText(context, "numQuestions: ${args.numQuestions}, numCorrect: ${args.numCorrect}", Toast.LENGTH_SHORT).show()

        setHasOptionsMenu(true) // To access menu lifecycle function
        return binding.root
    }
    ...
    /**
     * Navigate to about fragment when item is selected. Item id holds destination name
     */
